...
3. It streams `ds3d/datamap` to the `nvds3dfilter` `Gst-plugin`  which loads `point2cloud_datafilter` to convert 2D depth into 3D points. For more details on `nvds3dfilter` `Gst-plugin`, See [Gst-nvds3dfilter](/text/DS_plugin_gst-nvds3dfilter).
